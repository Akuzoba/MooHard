...
export function FlashcardsView({
    ...
    >
      ...
      >
        <CardContent className="flex flex-col justify-center items-center h-full p-8 text-center bg-gray-900">
          ...
          {progress[`${cardIndex}-${card?.front?.slice(0, 20)}`] && (
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Main Flashcard */}
      <Card className="bg-gray-100 min-h-[500px]">
        <CardContent className="p-8">
          ...
          >
            ...
            >
              {currentCard &&
                renderFlashcard(currentCard, currentIndex, isFlipped)}
            </div>
            ...
            {isTransitioning && (
              ...
              >
                {nextCardData &&
                  renderFlashcard(nextCardData, nextIndex, false)}
              </div>
            )}
